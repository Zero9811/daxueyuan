...
import com.daxueyuan.repository.OrderRecordRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public List<OrderRecord> findCancelOrders(String account) {
        List<OrderRecord> list1 = orderRecordRepository.findByCreatorAccountAndOrderState(account, OrderStateEnum.CANCEL.getCode());
        List<OrderRecord> list2 = orderRecordRepository.findByReceiverAccountAndOrderState(account, OrderStateEnum.CANCEL.getCode());
        list1.addAll(list2);
        return list1;
    }
